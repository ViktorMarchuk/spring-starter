...
(
    company_id  int references springdata.company (id),
    lang        varchar(32),
...
(
    id          bigserial primary key,
    amount      int    not null,
    receiver_id bigint not null references springdata.users (id)
);
...
(
    id      bigserial primary key,
    user_id bigint not null references springdata.users (id),
    chat_id bigint not null references springdata.chat (id),
